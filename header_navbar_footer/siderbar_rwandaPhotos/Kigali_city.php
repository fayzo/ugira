  <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><i>Kigali city</i></h1>
            </div>

            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Landscapes</li>
    ...
    <div class="row">
     ...
     <div id="jssor_5" style="position:relative;margin:0 auto;top:0px;left:0px;width:940px;height:380px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:940px;height:380px;overflow:hidden;">
            ...
            <?php echo $landscapes->CarouseKigalicityList('Kigali-city'); ?>
        </div>
        <!-- Thumbnail Navigator -->
    ...
    <span id="Kigali-city">
       <?php echo $landscapes->KigalicityList('Kigali-city'); ?> 
    </span>
   </div> <!-- col -->
  </div><!-- row -->
  </div><!-- districts -->