...
if (isset($_POST['deletecomment_id']) && !empty($_POST['deletecomment_id'])) {
    ...
    $comment->delete('events_comment',array('comment_id' => $comment_id,'comment_by' => $user_id));
