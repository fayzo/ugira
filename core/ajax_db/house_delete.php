                    ...
                    <li class="time-label">
                        ...
                        <div class="card-body pt-0">
                           <div class="text-primary mb-0">
                              <a class="text-primary float-left" href="javascript:void(0)" id="house-readmore" data-house="<?php echo $houses['house_id']; ?>" ><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo $houses['cell']."/".$houses['sector']; ?></a>
