$(document).ready(function () {
    ...
    $(document).on('click', '#add_news', function (e) {
        ...
        $('.progress-hidez').hide();
        e.stopPropagation();
        var news_view = $(this).data('news');

        $.ajax({
            url: 'core/ajax_db/news_addcategories.php',
            method: 'POST',
            dataType: 'text',
            data: {
                news_view: news_view,
    ...
    $(document).on('click', '#news-readmore', function (e) {
        e.stopPropagation();
        var news_id = $(this).data('news');

        $.ajax({
            url: 'core/ajax_db/news_readmore.php',
            method: 'POST',
            dataType: 'text',
            data: {
                news_id: news_id,
    ...
    $(document).on('click', '#form-news', function (e) {
